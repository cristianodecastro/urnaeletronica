...
#define OPTION_JUSTIFICA_VOTO 9
		...
		while(urna_estado == OPERACIONAL){
			...
			switch(menu_index){
				...
				case 9:
					...
					else if(tecla == 'A') {option_menu_operacional = OPTION_JUSTIFICA_VOTO; menu_index = 0;}
					break;
				default:
					break;
			}
			...
			switch(option_menu_operacional){
				...
				case OPTION_JUSTIFICA_VOTO:
				    validacao_justificativa = justifica_voto();
				    break;
			}
